...
class BrokerAPI:
    ...
    def place_short_order(self, symbol: str, side: str, quantity: float, type: str = 'MARKET', timeInForce: str = 'GTC',
                          price=None, sideEffectType: str = 'AUTO_REPAY'):
        """
    ...
    def place_long_order(self, symbol: str, side: str, quantity: float, type: str = 'MARKET', timeInForce: str = 'GTC',
                         price=None):
        """
        places order in broker server\n
        returns dictionary 
